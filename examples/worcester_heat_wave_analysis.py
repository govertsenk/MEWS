...
@author: govertsenk (adopted from dlvilla)

This scripting and functions run MEWS for output weather files of increasing frequency and severity of heat waves between 2020 and 2050
for a range of IPCC scenarios in a probabilistic context.

The study is for Worcester, MA. This routine is called from run_worcester_study.bat
...
--random_seed=5(19419765)   Just to be sure that results are replicable (starting small)
